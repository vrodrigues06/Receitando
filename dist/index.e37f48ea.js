...
var _uploadViewJs = require("./views/uploadView.js");
var _uploadViewJsDefault = parcelHelpers.interopDefault(_uploadViewJs);
var _regeneratorRuntime = require("regenerator-runtime");
const controlPagination = function(el) {
    const { search } = _modelJs.state;
    if (el.classList.contains("pagination__btn--prev")) --search.page;
    if (el.classList.contains("pagination__btn--next")) ++search.page;
    (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage(search.page));
    (0, _paginationViewJsDefault.default).render(search);
};
...
const controlServings = function(numServing, btn) {
    ...
    _modelJs.updateServings(numServing);
    (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe);
};
...
const controlAddRecipe = async function(newRecipe) {
    try {
        await _modelJs.uploadRecipe(newRecipe, (0, _uploadViewJsDefault.default).createArrayOfIngredients());
...
const controlAddIngredients = function() {
    (0, _uploadViewJsDefault.default).renderIngredientInput();
};
const b = "oi";
(function() {
    ...
    (0, _uploadViewJsDefault.default).addHandlerIngredients(controlAddIngredients);
})();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./views/uploadView.js":"6e9R8","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const loadRecipe = async function(id) {
    try {
        const dataObj = await (0, _helpers.AJAX)(`${(0, _config.API_URL)}/${id}?key=${(0, _config.API_KEY)}`);
        // Edit the Obj
        state.recipe = createRecipeObject(dataObj);
...
const uploadRecipe = async function(newRecipe, ingsArray) {
    try {
        const ingredients = ingsArray.map((ing)=>{
...
const API_KEY = "87521168-a2dc-4049-8064-a6c31f5f81bc";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "N\xe3o encontramos nenhuma receita. Por favor, tente outra!";
    _message;
    ...
    _ingredientsToHtml() {
        ...
        <div class="recipe__quantity">${!ing.quantity ? ing.quantity = "" : ing.quantity}</div>
    ...
    <div class="recipe__info">
      ...
      <span class="recipe__info-text">Por\xe7\xf5es</span>
    ...
    <p class="recipe__directions-text">
      ...
      <span class="recipe__publisher">${this._data.publisher}</span>. Por favor, confira as instru\xe7\xf5es no site deles.
    </p>
    <a
...
},{"url:../../img/icons.svg":"loVOp","./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "Nenhuma receita encontrada para sua busca! Por favor, tente novamente.";
    _message;
    _generateHtml() {
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateHtml() {
        ...
        if (currentPage === 1 && numPages > 1) return this._generateBtnNext(currentPage);
        // Page 1 and there aren't other pages
        if (numPages === 1) return "";
        // Last Page
        if (currentPage === numPages && currentPage > 1) return this._generateBtnPrev(currentPage);
        // other pages
        if (currentPage > 1 && currentPage < numPages) return `${this._generateBtnNext(currentPage)} 
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "Ainda n\xe3o h\xe1 favoritos. Encontre uma boa receita e marque-a :)";
    _message = "";
    addHandlerRender(handler) {
...
class AddRecipeView extends (0, _viewDefault.default) {
    ...
    toggleWindow() {
        ...
        this._navList.classList.add("closing");
        this._navList.classList.remove("ativo");
    }
    ...
    addHandlerUpload(handler) {
        this._parentEl.addEventListener("submit", function(e) {
            e.preventDefault();
            // Modern way to handle with forms
            const dataArr = [
                ...new FormData(this)
            ];
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6e9R8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class UploadView extends (0, _viewDefault.default) {
    ...
    createArrayOfIngredients() {
        const containersIngs = document.querySelectorAll(".ingredient__container--input");
        const ingsArray = [
            ...containersIngs
        ].map((container)=>{
...
exports.default = new UploadView();
